...
export function TestCaseLibraryPage() {
  ...
  return (
    ...
    >
      ...
      {query.isError ? <Alert type="error" showIcon message="加载失败" description={toApiError(query.error).userMessage} action={<Button onClick={() => void query.refetch()}>重试</Button>} style={{ marginBottom: 16 }} /> : null}
